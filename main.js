...
function gameEnd(win) {
    ...
    winPercent.textContent = (Number.parseInt(JSON.parse(window.localStorage.getItem('wins'))) / Number.parseInt(JSON.parse(window.localStorage.getItem('gamesPlayed')))).toFixed(2) * 100 + '%'
